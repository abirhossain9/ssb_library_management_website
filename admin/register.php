    ...
    <div class="card-body">
      ...
      <?php if (isset($_POST['register'])) {
          ...
          if ($password == $repassword) {
              ...
              $query = "INSERT INTO users(fullname,username,email,password,join_date) VALUES ('$fullname','$username','$email','$hashedPass', now())";
              ...
              echo '<div class = "alert alert-danger"  style="margin-top: 15px;"> Password Doesnt match</div>';
          }
      } ?>
